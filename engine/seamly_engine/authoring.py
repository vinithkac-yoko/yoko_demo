...
def new_pattern(name: str = "Untitled pattern", *, unit: str = "cm",
    ...
    origin = PatternObject(
        id=1, tag="point", tool_type="single",
        raw={"id": "1", "type": "single", "name": origin_name,
             "x": "0", "y": "0", "mx": "0.13", "my": "0.26", "showPointName": "true"},
    )
